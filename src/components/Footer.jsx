  ...
  return (
    <footer className="bg-blue-900 text-gray-100 pt-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        {/* Contact Info */}
        <div>
          <h2 className="text-xl font-semibold text-orange-600 mb-4">Contact</h2>
        ...
        {/* Quick Links */}
        <div>
          <h2 className="text-xl font-semibold text-orange-600 mb-4">Quick Links</h2>
          <ul className="space-y-3">
            <li><a href="/" className="hover:text-orange-500 transition" aria-label="Home Page">Home</a></li>
            <li><a href="/about" className="hover:text-orange-500 transition" aria-label="About Page">About</a></li>
            <li><a href="/locations" className="hover:text-orange-500 transition" aria-label="Locations Page">Locations</a></li>
            <li><a href="/contact" className="hover:text-orange-500 transition" aria-label="Contact Page">Contact</a></li>
          </ul>
        </div>

        {/* Social & Brand */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-orange-600">Next Go Shift</h2>
          ...
          <div className="flex space-x-4 mt-2">
            ...
            <a href="https://www.linkedin.com/in/narasimha-gunje/" target="_blank" rel="noopener noreferrer" aria-label="Visit our LinkedIn Page">
              <FaLinkedin className="text-2xl hover:text-orange-500" aria-hidden="true" />
            </a>
          </div>
        </div>
      </div>
